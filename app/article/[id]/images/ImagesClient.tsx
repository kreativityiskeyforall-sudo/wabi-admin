...
export default function ImagesClient({ id, article }: { id: string; article: SheetArticle | null }) {
  ...
  const [pinPrompt, setPinPrompt] = useState(
    `Minimalist japandi ${article?.category?.toLowerCase() ?? 'living room'} interior, warm neutral tones, natural wood furniture, linen textiles, dried botanicals, soft morning light, calm serene atmosphere, interior photography`
  );
          ...
          <div className="sec-panel">
            ...
            <div className="sec-card">
              ...
              <div className="sec-body">
                <textarea className="prompt-ta" defaultValue={`Bright airy japandi ${article?.category?.toLowerCase() ?? 'living room'}, white oak furniture, natural rattan basket, sage green cushions, large window with sheer curtains, warm afternoon light, minimalist decor, editorial interior photography`} />
              </div>
            </div>
