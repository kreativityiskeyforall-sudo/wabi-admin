...
export default function PinterestPage() {
  ...
  const scheduleAll = async () => {
    // TODO: call /api/pins with Pinterest API
            ...
            <div key={pin.id} className="pin-card">
              ...
              <div className="pin-card-body">
                ...
                <div className="pin-field">
                  ...
                  <div className="pin-url">wabidecor.com/{article?.category?.toLowerCase().replace(' ', '-') ?? 'living-room'}/{article?.slug ?? 'article-slug'}</div>
                </div>
                <div className="pin-field">
