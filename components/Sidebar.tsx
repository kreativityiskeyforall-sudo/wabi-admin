  ...
  return (
    <nav className="sb">
      ...
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        .sb-tab { flex: 1; padding: 8px 4px; font-size: 10px; font-weight: 600; font-family: inherit; background: none; border: none; cursor: pointer; color: var(--t3); transition: color .12s; position: relative; display: flex; align-items: center; justify-content: center; gap: 4px; }
        .sb-tab.on { color: var(--t1); border-bottom: 2px solid var(--t1); margin-bottom: -1px; }
        .sb-tab:hover { color: var(--t2); }
        .sb-tab-badge { background: var(--amber); color: white; font-size: 8px; padding: 1px 4px; border-radius: 8px; font-weight: 700; }
        ...
        .pub-action-btn { padding: 4px 8px; font-size: 10px; font-weight: 600; font-family: inherit; border: 1px solid var(--border); border-radius: 4px; background: white; cursor: pointer; color: var(--t2); text-decoration: none; display: inline-block; }
